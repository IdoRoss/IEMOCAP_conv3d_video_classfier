...
def C3D_groundup_model(num_classes):
    model = C3D_model(weights_path=None, summary=False, trainable=True, num_layers_remove=0)
    model.add(Dense(num_classes, activation='softmax', name='fc9'))
    model.summary()
    return model
...
def C3D_model(weights_path=None, summary=True, trainable=True, num_layers_remove=0):
    """
